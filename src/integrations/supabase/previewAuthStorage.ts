...
// On preview hosts, broker the auth session to a parent editor over postMessage
// so preview surfaces share one login; otherwise use localStorage.
export function brokeredPreviewStorage() {
  ...
  // Post only to a validated editor ancestor origin so the session token
  // cannot reach an untrusted embedder.
